...
public class ventanaAñadirProductoController {
	...
	public void onAñadirClicked(MouseEvent event) {
        ...
        Productos nuevo = new Productos(referenciaTxt.getText(), nombreTxt.getText(), iva, tipoProductoTxt.getText(), impuesto, tipoJuegoTxt.getText(), valorUnitario, plataformaTxt.getText());
