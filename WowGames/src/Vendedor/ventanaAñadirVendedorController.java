...
public class ventanaAñadirVendedorController implements Initializable{
	...
	@FXML
	private TextField ConsultarCredencialTxt;
	@FXML
	...
	public void onAñadirClicked(MouseEvent event) {
		// TODO Autogenerated
		Vendedores nuevo = new Vendedores(credencialTxt.getText(), identificacionTxt.getText(), nombreTxt.getText(), apellidoTxt.getText(), fechaIngreso, contraseñaTxt.getText());
        ...
        if (successAñadirVendedor) {
            ...
            alt.setContentText("Vendedor Añadido");
	 ...
	 @FXML
	    void OnConsultarClicked(MouseEvent event) {
			...
			Vendedores vendedor = dataProvider.consultarVendedor(ConsultarCredencialTxt.getText());
			if(vendedor.getCredencial() != null) {
				this.data.add(vendedor);
